    ...
    children: [
      {
        ...
        items: [
          {
            label: "Credit Score FREE",
            href: "/credit-score/free-cibil-score",
          },
          { label: "FREE CIBIL Score", href: "/credit-score/free-cibil-score" },
          {
            label: "FREE Experian Score",
            href: "/credit-score/free-experian-score",
          },
          {
            label: "FREE Equifax Score",
            href: "/credit-score/free-equifax-score",
          },
      ...
      },
      {
        ...
        items: [
          {
            label: "CIBIL Score Check by PAN Number",
            href: "/credit-score/cibil-by-pan",
          },
          { label: "SBI CIBIL Score", href: "/credit-score/sbi-cibil" },
          {
            label: "How to Increase CIBIL Score",
            href: "/credit-score/how-to-increase-cibil",
          },
          {
            label: "CIBIL Score for Personal Loan",
            href: "/credit-score/cibil-for-personal-loan",
          },
          {
            label: "How to Raise & Resolve CIBIL Dispute",
            href: "/credit-score/raise-resolve-dispute",
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        items: [
          { label: "Compare All Cards", href: "/credit-cards/compare" },
          {
            ...
            href: "/credit-cards/beginners",
          },
          {
            label: "Improve Approval Odds",
            href: "/credit-cards/improve-approval",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <path
          d="M7 6h6M7 10h2m3 0h.01M7 14h.01M10 14h.01M13 14h.01"
          strokeLinecap="round"
        />
      </svg>
    ),
    children: [
      {
        ...
        items: [
          ...
          { label: "Home Loan Calculator", href: "/calculators/home-loan" },
          {
            ...
            href: "/calculators/credit-utilization",
          },
        ],
      },
    ],
...
function DropdownPanel({
  ...
  item: NavItem;
  onLeadClick: (product: LeadProduct) => void;
}) {
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          "0 8px 32px rgba(79,70,229,0.14), 0 2px 8px rgba(30,27,75,0.06)",
                ...
                >
                  ...
                  {item.children && (
                    <svg
                      ...
                      style={{
                        transform:
                          mobileExpand === item.label ? "rotate(180deg)" : "",
                      }}
                      fill="none"
                      stroke="currentColor"
                      strokeWidth="2"
